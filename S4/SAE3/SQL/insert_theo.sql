...
INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (1, 'Pierre Dupont', 1);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (2, 'Sophie Martin', 1);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (3, 'Jacques Durand', 2);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (4, 'Claire Lemoine', 2);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (5, 'Lucie Bernard', 3);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (6, 'Marc Lefevre', 3);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (7, 'Émilie Petit', 4);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (8, 'François Dupuis', 4);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (9, 'David Moreau', 5);

INSERT INTO Intermittent (id_int, nom_int, id_to) 
VALUES (10, 'Isabelle Lefevre', 5);



INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (1, 'Lemoine', 'Julien', '12 Rue des Fleurs, Paris', 1);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (2, 'Bernard', 'Léa', '45 Avenue de la Mer, Lyon', 2);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (3, 'Durand', 'Maxime', '78 Boulevard des Lilas, Marseille', 2);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (4, 'Petit', 'Sophie', '23 Impasse des Écoles, Toulouse', 3);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (5, 'Lefevre', 'Lucas', '56 Rue des Artistes, Bordeaux', 3);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (6, 'Dupont', 'Clara', '89 Avenue du Lac, Lille', 4);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (7, 'Dupuis', 'Antoine', '12 Rue de la Liberté, Nantes', 4);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (8, 'Moreau', 'Emma', '34 Chemin des Vignes, Rennes', 5);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (9, 'Lemoine', 'Théo', '67 Boulevard des Champs, Paris', 5);

INSERT INTO Enfant (id_enfant, nom_enfant, prenom_enfant, adr_enfant, id_to) 
VALUES (10, 'Martins', 'Eva', '90 Rue des Champs, Strasbourg', 1);
...
INSERT INTO Demande (id_enfant, id_jouet, jouet_choisi) 
VALUES (3, 5, 'V');
RT INTO Demande (id_enfant, id_jouet, jouet_choisi) 
VALUES (10, 19, 'V');
INSERT INTO Demande (id_enfant, id_jouet, jouet_choisi) 
VALUES (3, 6, 'F');
...
INSERT INTO Est_stocke (id_jouet, region, quantite) 
VALUES (1, 'NA', 500);
...
INSERT INTO Est_affecte (region, id_int) 
VALUES ('NA', 1);
